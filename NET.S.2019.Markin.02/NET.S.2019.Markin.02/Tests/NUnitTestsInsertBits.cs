...
{
    [TestFixture]
    public class NUnitTestsInsertBits
    {
        [TestCase(8, 15, 0, 0, 9)]
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => InsertBits.InsertNumber(source, insert, start, end));
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => InsertBits.InsertNumber(source, insert, start, end));
        }
    }
}
